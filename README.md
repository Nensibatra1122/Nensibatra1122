...
| 🤖 **CLAIR — Autonomous Cleaning AI Robot** | Edge-computing autonomous robot using real-time computer vision for spatial mapping, navigation, and obstacle avoidance. | ![Python](https://img.shields.io/badge/Python-0
